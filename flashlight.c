...
static void flash_toggle(PluginState* const plugin_state) {
    ...
    furi_hal_gpio_init(&gpio_ext_pb2, GpioModeInputPushPull, GpioPullYes, GpioSpeedVeryHigh);
    ...
    furi_hal_gpio_init(&gpio_ext_pa4, GpioModeInputPushPull, GpioPullYes, GpioSpeedVeryHigh);
